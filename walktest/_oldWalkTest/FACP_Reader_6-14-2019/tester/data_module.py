import os
from device import Detector, Module
...
class TextReader:
    ...
    def read_device_list(self):
        '''
        Reads from a Device List text file and creates device objects
        Rework this section when you start breaking things into panel objects for the attribute
        locations. Make each line a sepereate method call on the data_reader object you will create.
        '''
    ...
    def read_test_device_list(self):
        """
        Reads from a Test History text file and creates list of events
...
class DataCenter(TextReader, ExcelWriter):
    ...
    def __init__(self):
        ...
        self.BASE_PATH = 'D:\\projects\\FACP_Reader\\tester\\static\\'
        self.data_file = os.path.join(self.BASE_PATH, 'Springfield Bulk Mail_2-3030_Device List.txt')
        self.test_file = os.path.join(self.BASE_PATH, 'Springfield Bulk Mail_2-3030_Test History.txt')
        self.excel_sheet = os.path.join(self.BASE_PATH, 'walktest.xlsx')
        self.devices = {
            "detectors": {},
            "modules": {}
        }
