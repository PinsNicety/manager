...
class DataCenter(TextReader, ExcelWriter):
    ...
    def __init__(self, panel_type):
        ...
        self.BASE_PATH = 'C:\\kraig\\Projects\\WalkTest\\FACP_Reader\\tester\\static\\'
        ...
        if panel_type == "2-3030":
            ...
            self.data_file = os.path.join(self.BASE_PATH, 'HWRSD_Hampden Schools_Greenmeadow School_Device List.txt')
            self.test_file = os.path.join(self.BASE_PATH, 'HWRSD_Hampden Schools_Greenmeadow School_Test History.txt')
